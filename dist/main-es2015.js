...
function AppComponent_div_3_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function AppComponent_div_3_Template_a_click_4_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r3); const ctx_r2 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r2.logout(); });
...
AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: AppComponent, selectors: [["app-root"]], decls: 5, vars: 2, consts: [["color", "primary"], [4, "ngIf"], ["mat-button", "", "routerLink", "/signup"], ["mat-button", "", "routerLink", "/login"], ["mat-button", "", "routerLink", "/home"], [1, "spacer"], ["mat-button", "", "routerLink", "/logout", 3, "click"]], template: function AppComponent_Template(rf, ctx) { if (rf & 1) {
...
/* harmony import */ var _loader_service__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ./loader.service */ "./src/app/loader.service.ts");
...
AppModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({ factory: function AppModule_Factory(t) { return new (t || AppModule)(); }, providers: [
        ...
        _loader_service__WEBPACK_IMPORTED_MODULE_21__["LoaderService"],
    ], imports: [[
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](AppModule, { declarations: [_app_component__WEBPACK_IMPORTED_MODULE_14__["AppComponent"],
        ...
        _logout_logout_component__WEBPACK_IMPORTED_MODULE_22__["LogoutComponent"]], imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"],
        _app_routing_module__WEBPACK_IMPORTED_MODULE_13__["AppRoutingModule"],
        _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormsModule"],
        _angular_forms__WEBPACK_IMPORTED_MODULE_2__["ReactiveFormsModule"],
        _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClientModule"],
...
class AuthService {
    constructor(http, loader, notifier) {
        this.http = http;
        this.loader = loader;
    ...
    placeOrder(manId, makeId, modelId) {
        return this.http.post('/api/placeorder', { manId, makeId, modelId }, this.getHeaders())
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(result => {
            return result.message;
        }));
    }
    getManufacturers(term, loader) {
        if (!term.trim()) {
            term = '';
        }
        // start loading
        this.loader.startLoading(loader);
        return this.http.get(`/api/allmanufacturers?term=${term}`, this.getHeaders())
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(result => {
            return result.items;
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(result => {
            // stop loading
            this.loader.stopLoading(loader);
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])((err) => this.handlerError(err, loader)));
    }
    getMakeForManufacturer(manId, term, loader) {
        // start loading
        this.loader.startLoading(loader);
        return this.http.get(`/api/makeformanufacturer?man_id=${manId}&term=${term}`, this.getHeaders())
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(result => result.items), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(result => {
            // stop loading
            this.loader.stopLoading(loader);
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])((err) => this.handlerError(err, loader)));
    }
    getModelsForMake(name, id, term, loader) {
        // start loading
        this.loader.startLoading(loader);
        return this.http.get(`/api/getmodelsformake/${name}?makeid=${id}&term=${term}`, this.getHeaders())
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(result => result.items), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(result => {
            // stop loading
            this.loader.stopLoading(loader);
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])((err) => this.handlerError(err, loader)));
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](AuthService, [{
    ...
    }], function () { return [{ type: _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"] }, { type: _loader_service__WEBPACK_IMPORTED_MODULE_4__["LoaderService"] }, { type: _notifications_service__WEBPACK_IMPORTED_MODULE_5__["NotificationsService"] }]; }, null); })();
...
class HomeComponent {
    constructor(auth, formBuilder, loader, router, notifier) {
        this.auth = auth;
    ...
    onSubmit() {
        this.auth.placeOrder(this.selectedManfacturer.Mfr_ID, this.selectedMake.Make_ID, this.selectedModel.Model_ID)
    ...
    setInputStatuses(makeEnable, makeReset, modelEnable, modelReset) {
        if (makeEnable) {
...
HomeComponent.ɵfac = function HomeComponent_Factory(t) { return new (t || HomeComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_auth_service__WEBPACK_IMPORTED_MODULE_3__["AuthService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormBuilder"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_loader_service__WEBPACK_IMPORTED_MODULE_4__["LoaderService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_5__["Router"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_notifications_service__WEBPACK_IMPORTED_MODULE_6__["NotificationsService"])); };
HomeComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: HomeComponent, selectors: [["app-home"]], decls: 13, vars: 23, consts: [[1, "home-app"], [1, "page-toolbar"], [1, "login-container"], [3, "formGroup"], [3, "label", "loading", "renderOptionInInput", "renderOptionInMenu", "parentForm", "nameOfControl", "dataSource", "onSelectOption"], [1, "card-actions"], ["mat-raised-button", "", "color", "primary", 3, "disabled", "click"]], template: function HomeComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("onSelectOption", function HomeComponent_Template_app_search_input_onSelectOption_7_listener($event) { return ctx.onSelectManufacturer($event); });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](8, "app-search-input", 4);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("onSelectOption", function HomeComponent_Template_app_search_input_onSelectOption_8_listener($event) { return ctx.onSelectMake($event); });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](9, "app-search-input", 4);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("onSelectOption", function HomeComponent_Template_app_search_input_onSelectOption_9_listener($event) { return ctx.onSelectModel($event); });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](10, "mat-card-actions", 5);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](11, "button", 6);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function HomeComponent_Template_button_click_11_listener() { return ctx.onSubmit(); });
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](HomeComponent, [{
    ...
    }], function () { return [{ type: _auth_service__WEBPACK_IMPORTED_MODULE_3__["AuthService"] }, { type: _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormBuilder"] }, { type: _loader_service__WEBPACK_IMPORTED_MODULE_4__["LoaderService"] }, { type: _angular_router__WEBPACK_IMPORTED_MODULE_5__["Router"] }, { type: _notifications_service__WEBPACK_IMPORTED_MODULE_6__["NotificationsService"] }]; }, null); })();
...
class LoaderService {
    ...
    addLoaders(names, value = false) {
        for (let i = 0; i < names.length; i++) {
            this.addLoader(names[i], value);
        }
    }
    addLoader(name, value = false) {
...
class LoginComponent {
    constructor(formBuilder, auth, router, notifier) {
        this.formBuilder = formBuilder;
        this.auth = auth;
        this.router = router;
        this.notifier = notifier;
    ...
    onSubmit() {
        this.auth.login(this.form.value.email, this.form.value.password)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["first"])())
            .subscribe(result => this.router.navigate(['home']), err => this.notifier.notify(err.error, 'Dismiss', false));
    }
    ngOnInit() {
...
LoginComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: LoginComponent, selectors: [["app-login"]], decls: 22, vars: 2, consts: [[1, "login-app"], [1, "page-toolbar"], [1, "login-container"], [3, "formGroup"], [1, "full-width"], ["matInput", "", "placeholder", "Email", "formControlName", "email"], ["matInput", "", "type", "password", "placeholder", "Password", "formControlName", "password"], [1, "card-actions"], ["mat-raised-button", "", "color", "primary", 3, "disabled", "click"], ["mat-button", "", "routerLink", "/signup", "color", "accent"]], template: function LoginComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "mat-toolbar", 1);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](2, "div");
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](LoginComponent, [{
    ...
    }], function () { return [{ type: _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormBuilder"] }, { type: _auth_service__WEBPACK_IMPORTED_MODULE_3__["AuthService"] }, { type: _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"] }, { type: _notifications_service__WEBPACK_IMPORTED_MODULE_5__["NotificationsService"] }]; }, null); })();
...
LogoutComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: LogoutComponent, selectors: [["app-logout"]], decls: 3, vars: 0, consts: [[1, "page-toolbar"]], template: function LogoutComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-toolbar", 0);
...
class NotificationsService {
    ...
    notify(message, action, success = true, duration = 4000) {
...
function SearchInputComponent_mat_option_7_Template(rf, ctx) { if (rf & 1) {
...
function SearchInputComponent_div_9_Template(rf, ctx) { if (rf & 1) {
...
class SearchInputComponent {
    ...
    initItems() {
        ...
        Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["switchMap"])((term) => this.onDataSource(term)));
    }
    ngOnInit() {
        this.initItems();
    }
...
SearchInputComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: SearchInputComponent, selectors: [["app-search-input"]], inputs: { parentForm: "parentForm", nameOfControl: "nameOfControl", label: "label", loading: "loading", renderOptionInInput: "renderOptionInInput", renderOptionInMenu: "renderOptionInMenu", dataSource: "dataSource" }, outputs: { onSelectOption: "onSelectOption" }, decls: 10, vars: 9, consts: [[1, "full-width", 3, "formGroup"], ["type", "text", "aria-label", "search-input", "matInput", "", 1, "vs-input", 3, "formControlName", "matAutocomplete", "input", "click"], ["searchBox", ""], [3, "displayWith", "optionSelected"], ["automan", "matAutocomplete"], [3, "value", 4, "ngFor", "ngForOf"], ["class", "vs-spinner-wrapper", 4, "ngIf"], [3, "value"], [1, "vs-spinner-wrapper"], ["diameter", "20"]], template: function SearchInputComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("input", function SearchInputComponent_Template_input_input_3_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r5); const _r0 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵreference"](4); return ctx.onInputChange(_r0.value); })("click", function SearchInputComponent_Template_input_click_3_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r5); const _r0 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵreference"](4); return !_r0.value && ctx.onInputChange(_r0.value); });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](5, "mat-autocomplete", 3, 4);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("optionSelected", function SearchInputComponent_Template_mat_autocomplete_optionSelected_5_listener($event) { return ctx.onSelect($event); });
...
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/__ivy_ngcc__/fesm2015/forms.js");
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! rxjs/operators */ "./node_modules/rxjs/_esm2015/operators/index.js");
/* harmony import */ var _Validators_must_match__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../Validators/must_match */ "./src/app/Validators/must_match.ts");
...
class SignupComponent {
    ...
    ngOnInit() {
        ...
        const lastNameValidators = [_angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].maxLength(25)]; // avoid too long text
    ...
    onSubmit() {
        ...
        this.auth.signup(this.form.value.firstName, this.form.value.lastName, this.form.value.email, this.form.value.password)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["first"])())
            .subscribe(result => {
...
SignupComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: SignupComponent, selectors: [["app-signup"]], decls: 38, vars: 5, consts: [[1, "signup-app"], [1, "page-toolbar"], [1, "signup-container"], [3, "formGroup"], [1, "full-width"], ["matInput", "", "type", "text", "formControlName", "firstName"], ["class", "invalid-feedback", 4, "ngIf"], ["matInput", "", "type", "text", "formControlName", "lastName"], ["matInput", "", "type", "email", "formControlName", "email"], ["matInput", "", "type", "password", "placeholder", "Password", "formControlName", "password"], ["matInput", "", "type", "password", "formControlName", "confirmPassword"], [1, "card-actions"], ["mat-raised-button", "", "color", "primary", 3, "click"], ["mat-button", "", "routerLink", "/login", "color", "accent"], [1, "invalid-feedback"], [4, "ngIf"]], template: function SignupComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "mat-toolbar", 1);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](2, "div");
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](SignupComponent, [{
    ...
    }], function () { return [{ type: _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormBuilder"] }, { type: _auth_service__WEBPACK_IMPORTED_MODULE_4__["AuthService"] }, { type: _angular_router__WEBPACK_IMPORTED_MODULE_5__["Router"] }, { type: _notifications_service__WEBPACK_IMPORTED_MODULE_6__["NotificationsService"] }]; }, null); })();
...
module.exports = __webpack_require__(/*! /Users/jameel/Dropbox (Personal)/vehicles-store-test/client/vehicles-client/src/main.ts */"./src/main.ts");
